 HEAD
# module-SPA
Ce module vous permet d'acquérir les compétences fondamentales du développement front-end moderne, depuis les bases de JavaScript ES6+ jusqu'à la réalisation d'une Single Page Application complète avec Vue.js.
